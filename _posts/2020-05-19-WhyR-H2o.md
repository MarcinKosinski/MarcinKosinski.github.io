---
layout: post
title: Why R? Webinar - Scalable Automatic Machine Learning in R with H2O AutoML
comments: true
published: true
...
<img src="/images/fulls/webinars/erin.jpg" class="fit image"> May 21st (8:00pm UTC+2) will bring next fascinating webinar at Why R? Foundation YouTube channel. We will have a pleasure to host [Dr. Erin Ledell](https://twitter.com/ledell) from [H2O.ai](H2O.ai). The topic of the talk is **Scalable Automatic Machine Learning in R with H2O AutoML**.

See you on the [Webinar](https://www.youtube.com/watch?v=DjzKTeIIxOY)!
