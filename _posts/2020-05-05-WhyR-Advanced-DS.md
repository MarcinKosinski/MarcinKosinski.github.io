---
layout: post
title: Why R? Webinar - Advanced Data Preparation for Supervised Machine Learning
comments: true
published: true
...
<img src="/images/fulls/webinars/nina.jpg" class="fit image"> May 7th (8:00pm GMT+2) is the next date for a webinar at Why R? Foundation YouTube channel. We will have an amazing talk by Dr. Nina Zumel and Dr. John Mount from [win-vector](http://www.win-vector.com/). The title of the webinar is **Advanced Data Preparation for Supervised Machine Learning** which corresponds to [Practical Data Science with R](https://www.manning.com/books/practical-data-science-with-r-second-edition) book that Nina an John have written. Check out 40% discount code - **mtpwhyr20** - that you can use on all their goods [here](https://www.manning.com/books/practical-data-science-with-r-second-edition).

See you on the [Webinar](https://youtu.be/sniHkkrAsOc)!
